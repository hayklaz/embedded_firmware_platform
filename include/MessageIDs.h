...
typedef enum {
    ...
    ID_CHANNEL_FILTER, /** Byte with upper four bytes being channel and bottom 4 being filter, sent when there is a system change */
    ID_SET_FREQUENCY, /** Unsigned short representing a new frequency in the valid range */
    ID_FREQUENCY_ONOFF, /** Controls Frequency output: 0 Off, 1 ON */
